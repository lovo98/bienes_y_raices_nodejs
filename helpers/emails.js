...
const emailRegistro = async (datos) => {
    ...
    await transport.sendMail({
        ...
        html: `
            ...
            <p> Comprueba tu cuenta en el siguiente enlace:
...
const emailOlvidePassword = async (datos) => {
    ...
    await transport.sendMail({
        ...
        html: `
            ...
            <p> Sigue el siguiente enlace para generar nueva password:
                <a href="${process.env.BACKEND_URL}:${process.env.PORT ?? 3000}/auth/olvide-password/${token}">
                Restablecer password.<a/>
            </p>
            <p>Si tu no solicitaste password, puedes ignorar este mensaje.</p>
        `
    })
}
